...
| -------------- | -------------- | ---------------- | -------------------- | ---------- | --------- | ---------------- | :----------: |
| MOE_01 | CountryCode | varchar(2) | string | PK | [countries](https://dd.eionet.europa.eu/vocabulary/common/countries) |  | Y |
| MOE_02 | AssessmentMethodId | varchar(50) | string | PK |  | ComplianceAssessmentMethod<br>SpatialRepresentativeness<br>PollutionLevelAdjustment<br>PlanScenario<br>MOEResultInline<br>MOEResultExternal | Y |
| MOE_03 | DataAggregationProcessId | varchar(50) | string | PK | [aggregationprocess](https://dd.eionet.europa.eu/vocabulary/aq/aggregationprocess/view) | MOEResultInline<br>MOEResultExternal | Y |
| MOE_04 | AssessmentMethodName | varchar(150) | string |  |  |  | Y |
| MOE_05 | PollutantId | int | numeric |  | [pollutant](https://dd.eionet.europa.eu/vocabulary/aq/pollutant/view) |  | Y |
| MOE_06 | ResultEncoding | varchar(10) | string |  | [resultencoding](https://dd.eionet.europa.eu/vocabulary/aq/resultencoding) |  | Y |
| MOE_07 | MethodApplication | varchar(20) | string |  | [modelapplication](https://dd.eionet.europa.eu/vocabulary/aq/modelapplication) |  | Y |
| MOE_08 | GenericMQI | decimal(5,2) | numeric |  |  |  | Y |
| MOE_09 | DataQualityDocumentId | varchar(150) | string |  |  | Documentation | Y |
| MOE_10 | MethodDocumentId | varchar(150) | string |  |  | Documentation | Y |
