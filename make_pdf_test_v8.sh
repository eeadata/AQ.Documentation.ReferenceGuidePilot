...
DOCS="$ROOT/docs"
OUT="$ROOT/AQ_Reference_PDF_test_v8.pdf"
COMBINED="$DOCS/_pdf_test_v8.html"
...
echo "$OUT"
echo
echo "v8 keeps the successful v1/v3 rendering method and adds:"
...
echo "  - readable 7pt 8-column attribute tables with intact identifiers"
